...
live2d_settings['hitokotoAPI']          = 'https://api.xiaolin.in/hitokoto';                  // 一言 API，可选 'lwl12.com', 'hitokoto.cn', 'jinrishici.com'(古诗词)
...
live2d_settings['canSwitchModel']       = true;         // 显示 看板娘切换    按钮，可选 true(真), false(假)
live2d_settings['canSwitchTextures']    = true;         // 显示 衣服切换    按钮，可选 true(真), false(假)
...
live2d_settings['waifuToolTop']         = '-5px'         // 工具栏顶部边距，例如 '0px', '-60px'
live2d_settings['waifuMinWidth']        = '768px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
live2d_settings['waifuEdgeSide']        = 'right:50';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
